    ...
    <div style={{ width: "100%", paddingTop: "40px" }}>
      <div style={{ display: "flex", gap: "10px", justifyContent: "center" }}>
        <div style={{ width: "45%" }}>
          <Card className="card-chart">
            <CardHeader>
              ...
              <CardTitle tag="h3">
                <i className="tim-icons icon-send text-success" /> Production Vs
                Consumption
              </CardTitle>
            </CardHeader>
            <CardBody>
              <div className="chart-area">
                <Line
                  data={elecconsumptiondata[bigChartData]}
                  options={elecconsumptiondata.options}
                />
              </div>
            </CardBody>
          </Card>
        ...
        <div style={{ width: "45%" }}>
          <Card className="card-chart">
            <CardHeader>
              <h5 className="card-category">KILN 2 </h5>
              <CardTitle tag="h3">
                <i className="tim-icons icon-send text-success" /> Production Vs
                Consumption
              </CardTitle>
      ...
      <div style={{ display: "flex", gap: "10px", justifyContent: "center" }}>
        ...
        >
          <Card className="card-chart">
            <CardHeader>
              <h5 className="card-category">KILN 3</h5>
              <CardTitle tag="h3">
...
export default ElectricityConsumtion;
