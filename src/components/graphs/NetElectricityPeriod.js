...
import { netElectdata } from "../../variables/charts";

import "./graphsstyle.css";

const NetElectricityPeriod = () => {
          ...
          <Card className="card-chart">
            <CardHeader>
              ...
              <CardTitle tag="h3">
                ...
                Net Electricity from PP Gen 7.5
              </CardTitle>
            </CardHeader>
            <CardBody>
              <div className="chart-area">
                <Line
                  data={netElectdata[bigChartData]}
                  options={netElectdata.options}
                />
              </div>
            </CardBody>
          </Card>
        ...
        <div style={{ width: "45%" }}>
          <Card className="card-chart">
            <CardHeader>
              ...
              <CardTitle tag="h3">
                <i className="tim-icons icon-send text-success" />
                Net Electricity from PP Gen 18 .5
              </CardTitle>
            </CardHeader>
            <CardBody>
              <div className="chart-area">
...
export default NetElectricityPeriod;
